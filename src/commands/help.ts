...
const helpEmbed = new EmbedBuilder()
  ...
  .setDescription(
    [
      ...
      "- `/group delete group:<group>` - Delete a group (creator or Manage Server).",
      "- `/group rename group:<group> new-name:<name>` - Rename a group (creator or Manage Server).",
      "- `/group leave group:<group>` - Leave a group you are a member of.",
      ...
      "- `/settings timezone set timezone:<region/city>` - Set server default meetup timezone (with common choices, Manage Server).",
      "- `/settings timezone show` - Show server default meetup timezone.",
