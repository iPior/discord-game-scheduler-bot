...
const helpEmbed = new EmbedBuilder()
  ...
  .setDescription(
    [
      ...
      "- `/meetup propose group:<group> title:<title> time:<time>` - Post a meetup with RSVP buttons.",
      "- `/meetup status meetup_id:<id>` - Show RSVP lists for a meetup.",
      "- `/meetup edit meetup_id:<id> title:<optional> time:<optional>` - Edit your meetup.",
